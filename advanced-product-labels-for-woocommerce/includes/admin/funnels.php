<?php
if ( ! class_exists( 'brlabel_free_funnels' ) ) {
	class brlabel_free_funnels {
		...
		public function spring_premium_days_2026(): void {
			$plugin_version_capability = apply_filters( 'brfr_get_plugin_version_capability_products_label', 0 );
			$type = ( $plugin_version_capability >= 15 ) ? 'paid' : 'free';

			$name       = 'spring_premium_days_2026';
			$media      = '?utm_source=' . $type . '_plugin&utm_medium=admin_notice&utm_campaign=spring_2026&utm_content=top_banner_cta&utm_term=labels';
				...
				<div class="berocket-notice-template-big" style="">
					<div class="berocket-notice-description-container">
						...
						<ul style="font-size: 16px">
							<li>Eye-catching product labels for promotions</li>
							<li>Countdown timers that create urgency and FOMO</li>
							<li>Smart automation to highlight the right products</li>
						</ul>
					...
					<div class="berocket-notice-actions-container">
						...
						<div class="berocket-notice-buttons-container">
							<a href="https://berocket.com/woocommerce-advanced-product-labels/' . $media . '" 
							   class="button notice-action-link not_berocket_button" target="_blank" 
							   style="position: static; display: inline-block; right: 0; top: 0; margin: 0;font-size: 24px;padding-left: 25px;padding-right: 25px;">Upgrade Labels → 30% OFF</a>
